...
//
//   const pepe = Convert.toPepe(json);
//
...
export class Convert {
    public static toPepe(json: string): Country[] {
        return cast(JSON.parse(json), a(r("Pepe")));
    }

    public static pepeToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("Pepe"))), null, 2);
    }
}
